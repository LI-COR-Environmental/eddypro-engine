...
subroutine ExceptionHandler(error_code)
    ...
    select case (error_code)
        ...
        case(1)
            ...
            stop 1
        case(2)
            write(*,*) ' Error(2)> An error occurred while reading biomet data file. File not found or empty.'
            write(*,*) ' Error(2)> Biomet data in this file will not be used.'
        case(3)
            write(*,*) ' Error(3)> An error occurred while reading metadata file in GHG archive. File not found or empty.'
            write(*,*) ' Error(3)> GHG archive appears to be corrupted or invalid and will thus be skipped.'
        case(4)
            write(*,*) ' Error(4)> An error occurred while reading raw data file in GHG archive. File not found or empty.'
            write(*,*) ' Error(4)> GHG archive appears to be corrupted or invalid and will thus be skipped.'
        case(5)
            write(*,*) ' Error(5)> An error occurred while reading biomet data file or corresponding metadata file in GHG archive.'
            write(*,*) ' Error(5)> File(s) not found or empty. Biomet data not used for this time period.'
        case(6)
            write(*,*) ' Error(6)> An error occurred while opening current raw data file. File is empty.'
            write(*,*) ' Error(6)> Raw data file skipped.'
        case(7)
            write(*,*)
            write(*,*) ' Error(7)> An error occurred while opening INI-format file. Looking for a solution..'
        case(8)
            ...
            stop 1
        case(14)
            write(*,*) ' Error(14)> An error occurred while unzipping GHG archive. File skipped.'
        case(20)
        ...
        case(22)
            ...
            stop 1
        case(23)
            write(*,*) '  Fatal error(23)> An error occurred while validating "Alternative metadata file".'
        ...
        case(28)
            write(*,*) '  Error(28)> An error occurred while opening raw data file.'
            write(*,*) '  Error(28)> Raw file skipped.'
        case(29)
            write(*,*) ' Alert(29)> An error occurred while reading rotation matrices from auxiliary planar-fit file.'
            write(*,*) ' Alert(29)> Axis rotation method switched to "Double rotation".'
        case(30)
            write(*,*) ' Alert(30)> An error occurred while opening auxiliary file for planar-fit. File not found or empty.'
            write(*,*) ' Alert(30)> Axis rotation method switched to "Double rotation".'
        case(31)
            write(*,*) ' Fatal error(31)> Unrecognised TOB1 data format. Select either IEEE4 or FP2 data formats and try again.'
        ...
        case(34)
            write(*,*) ' Error(34)> An error occurred while calculating planar-fit rotations &
        ...
        case(40)
            write(*,*) ' Alert(40)> An error occurred while retrieving wind sectors configuration for planar-fit.'
        ...
        case(44)
            write(*,*) ' Error(44)> An error occurred while reading or interpreting biomet file.'
        ...
        case(52)
            write(*,*) '  Fatal error(52)> An unexpected, unrecognised internal error occurred.'
        ...
        case(54)
            write(*,*) '  Error(54)> An error occurred while opening or reading SLT (binary) file.'
            write(*,*) '  Error(54)> Raw file skipped.'
        case(55)
            write(*,*) '  Error(55)> An error occurred while opening or reading generic binary file.'
            write(*,*) '  Error(55)> Raw file skipped.'
        case(56)
            write(*,*) '  Error(56)> An error occurred while opening or reading TOB1 (binary) file.'
            write(*,*) '  Error(56)> Raw file skipped.'
        case(57)
            write(*,*) '  Error(57)> An error occurred while opening or reading ASCII file.'
        ...
        case(59)
            ...
            write(*,*) '  Error(59)> If this error appears for many or all raw files, check those settings.'
            write(*,*) '  Error(59)> Skipping to next averaging period.'
        case(60)
            write(*,*) ' Fatal error(60)> An error occurred while opening or reading "essentials" file.'
        ...
        case(61)
            ...
            stop 1
        case(62)
            write(*,*) ' Error(62)> An error occurred while reading binned (co)spectra file.'
            write(*,*) ' Error(62)> File skipped.'
        case(63)
            write(*,*) ' Error(63)> An error occurred while reading full (co)spectra file.'
            write(*,*) ' Error(63)> File skipped.'
        case(64)
            write(*,*) ' Error(64)> An error occurred while creating output file.'
            write(*,*) ' Error(64)> Some spectral assessment results will not be written on output file.'
        case(65)
            write(*,*) ' Alert(65)> An error occurred while reading auxiliary "spectral assessment" file.'
        ...
        case(67)
            write(*,*) ' Error(67)> An error occurred while opening output file.'
            write(*,*) ' Error(67)> Output dataset not created.'
        case(68)
            write(*,*) ' Error(68)> An error occurred while reading dynamic metadata file. File not found or empty.'
...
!        case(9)
!            write(*,*) ' Fatal error(9)> An error occurred while opening statistics file.'
!            write(*,*) ' Fatal error(9)> Program execution aborted.'
!            stop 1
!        case(10)
!            write(*,*) ' Fatal error(10)> An error occurred while reading statistics file. No valid data lines found in file.'
...
!            stop 1
!        case(12)
!            write(*,*) ' Fatal error(12)> An error occurred while opening provisional fluxes file.'
...
!            stop 1
!        case(17)
!            write(*,*) '  Error(17)> An error occurred while opening w/h2o covariances file.'
!            write(*,*) '  Error(17)> EddyPro will use maximized w/h2o covariances instead. Execution continues.'
!        case(18)
!            write(*,*) '  Error(18)> An error while reading w/h2o file. No valid data lines were found in the file.'
