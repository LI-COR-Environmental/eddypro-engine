...
!***************************************************************************
!
! \brief       Convenient variables related to dates
! \author      Gerardo Fratini
! \note
! \sa
! \bug
! \deprecated  Probably soon to be deprecated
! \test
! \todo
!***************************************************************************
module m_dates
    integer :: kk = 40
    integer, parameter :: nyears = 40
    integer, parameter :: ndays = 365
    integer, parameter :: lndays = 366
    integer, parameter :: nhours = 48
    character(4) :: Year(nyears)
    character(5) :: DayOfYear(ndays)
    character(5) :: DayOfLeapYear(lndays)
    character(5) :: Hours(nhours)

    data (Year(kk), kk = 1, nyears) /&
    '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', &
    '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', &
    '2021', '2022', '2023', '2024', '2025', '2026', '2027', '2028', '2029', '2030', &
    '2031', '2032', '2033', '2034', '2035', '2036', '2037', '2038', '2039', '2040' /

    data (DayOfYear(kk), kk = 1, ndays) /&
    ...
    '02-24', '02-25', '02-26', '02-27', '02-28', '03-01', '03-02', '03-03', '03-04', &
    '03-05', '03-06', '03-07', '03-08', '03-09', '03-10', '03-11', '03-12', '03-13', &
    ...
    '04-28', '04-29', '04-30', '05-01', '05-02', '05-03', '05-04', '05-05', '05-06', &
    '05-07', '05-08', '05-09', '05-10', '05-11', '05-12', '05-13', '05-14', '05-15', &
    '05-16', '05-17', '05-18', '05-19', '05-20', '05-21', '05-22', '05-23', '05-24', &
    '05-25', '05-26', '05-27', '05-28', '05-29', '05-30', '05-31', '06-01', '06-02', &
    '06-03', '06-04', '06-05', '06-06', '06-07', '06-08', '06-09', '06-10', '06-11', &
    '06-12', '06-13', '06-14', '06-15', '06-16', '06-17', '06-18', '06-19', '06-20', &
    '06-21', '06-22', '06-23', '06-24', '06-25', '06-26', '06-27', '06-28', '06-29', &
    '06-30', '07-01', '07-02', '07-03', '07-04', '07-05', '07-06', '07-07', '07-08', &
    '07-09', '07-10', '07-11', '07-12', '07-13', '07-14', '07-15', '07-16', '07-17', &
    '07-18', '07-19', '07-20', '07-21', '07-22', '07-23', '07-24', '07-25', '07-26', &
    '07-27', '07-28', '07-29', '07-30', '07-31', '08-01', '08-02', '08-03', '08-04', &
    '08-05', '08-06', '08-07', '08-08', '08-09', '08-10', '08-11', '08-12', '08-13', &
    '08-14', '08-15', '08-16', '08-17', '08-18', '08-19', '08-20', '08-21', '08-22', &
    ...
    '10-25', '10-26', '10-27', '10-28', '10-29', '10-30', '10-31', '11-01', '11-02', &
    ...
    data (DayOfLeapYear(kk), kk = 1, lndays) /&
    '01-01', '01-02', '01-03', '01-04', '01-05', '01-06', '01-07', '01-08', '01-09', &
    '01-10', '01-11', '01-12', '01-13', '01-14', '01-15', '01-16', '01-17', '01-18', &
    '01-19', '01-20', '01-21', '01-22', '01-23', '01-24', '01-25', '01-26', '01-27', &
    '01-28', '01-29', '01-30', '01-31', '02-01', '02-02', '02-03', '02-04', '02-05', &
    '02-06', '02-07', '02-08', '02-09', '02-10', '02-11', '02-12', '02-13', '02-14', &
    '02-15', '02-16', '02-17', '02-18', '02-19', '02-20', '02-21', '02-22', '02-23', &
    '02-24', '02-25', '02-26', '02-27', '02-28', '02-29', '03-01', '03-02', '03-03', '03-04', &
    '03-05', '03-06', '03-07', '03-08', '03-09', '03-10', '03-11', '03-12', '03-13', &
    '03-14', '03-15', '03-16', '03-17', '03-18', '03-19', '03-20', '03-21', '03-22', &
    '03-23', '03-24', '03-25', '03-26', '03-27', '03-28', '03-29', '03-30', '03-31', &
    '04-01', '04-02', '04-03', '04-04', '04-05', '04-06', '04-07', '04-08', '04-09', &
