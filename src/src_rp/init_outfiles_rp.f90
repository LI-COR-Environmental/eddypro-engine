...
subroutine InitOutFiles_rp()
    ...
    if (EddyProProj%out_icos) then
        ...
        call clearstr(dataline)
        dataline = 'TIMESTAMP,POTENTIAL_RADIATION,NIGHT,EXPECT_NR,&
                  ...
                  &TAU,H,LE,FC,FH2O,FCH4,FGS4,TAU_RANDUNC_HF,H_RANDUNC_HF,LE_RANDUNC_HF,FC_RANDUNC_HF,FH2O_RANDUNC_HF,FCH4_RANDUNC_HF,FGS4_RANDUNC_HF,&
                  ...
                  &WS,WS_MAX,WD,USTAR,TKE,MO_LENGTH,ZL,BOWEN,TSTAR,&
                  ...
                  &U_MEDIAN,V_MEDIAN,W_MEDIAN,T_SONIC_MEDIAN,CO2_MEDIAN,H2O_MEDIAN,CH4_MEDIAN,GS4_MEDIAN,&
                  &U_P25,V_P25,W_P25,T_SONIC_P25,CO2_P25,H2O_P25,CH4_P25,GS4_P25,&
                  &U_P75,V_P75,W_P75,T_SONIC_P75,CO2_P75,H2O_P75,CH4_P75,GS4_P75,&
                  &U_SIGMA,V_SIGMA,W_SIGMA,T_SONIC_SIGMA,CO2_SIGMA,H2O_SIGMA,CH4_SIGMA,GS4_SIGMA,&
                  &U_SKW,V_SKW,W_SKW,T_SONIC_SKW,CO2_SKW,H2O_SKW,CH4_SKW,GS4_SKW,&
                  &U_KUR,V_KUR,W_KUR,T_SONIC_KUR,CO2_KUR,H2O_KUR,CH4_KUR,GS4_KUR,&
                  &W_U_COV,W_T_SONIC_COV,W_CO2_COV,W_H2O_COV,W_CH4_COV,W_GS4_COV,&
                  &CO2_H2O_COV,CO2_CH4_COV,CO2_GS4_COV,H2O_CH4_COV,H2O_GS4_COV,CH4_GS4_COV,&
                  ...
                  &U_SPIKE_TOL_NR,V_SPIKE_TOL_NR,W_SPIKE_TOL_NR,T_SONIC_SPIKE_TOL_NR,&
                  &CO2_SPIKE_TOL_NR,H2O_SPIKE_TOL_NR,CH4_SPIKE_TOL_NR,GS4_SPIKE_TOL_NR,&
