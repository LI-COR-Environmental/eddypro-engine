...
subroutine InitOutFiles_rp()
    ...
    if (EddyProProj%out_icos) then
        ...
        dataline = 'TIMESTAMP,DAYTIME,NR_THEOR,NR_1,NR_2,NR_3,NR_WIND,NR_TS,NR_CO2,NR_H20,NR_CH4,NR_GS4,&
                  ...
                  &CO2_TLAG_ACTUAL,CO2_TLAG_USED,CO2_TLAG_DEFAULT,CO2_TLAG_MIN,CO2_TLAG_MAX,&
                  &H2O_TLAG_ACTUAL,H2O_TLAG_USED,H2O_TLAG_DEFAULT,H2O_TLAG_MIN,H2O_TLAG_MAX,&
                  &CH4_TLAG_ACTUAL,CH4_TLAG_USED,CH4_TLAG_DEFAULT,CH4_TLAG_MIN,CH4_TLAG_MAX,&
                  &GS4_TLAG_ACTUAL,GS4_TLAG_USED,GS4_TLAG_DEFAULT,GS4_TLAG_MIN,GS4_TLAG_MAX,&
                  ...
                  &VM97_TMELAG_HFLAG,VM97_TMELAG_SFLAG,VM97_AOA_HFLAG,VM97_NSW_HFLAG,&
                  ...
                  &ROT_YAW,ROT_PITCH,ROT_ROLL,DETRENDING_METHOD,DENTRENDING_TIME_CONSTANT,&
                  &LOGGER_SWVER_MAJOR,LOGGER_SWVER_MINOR,LOGGER_SWVER_REVISION,&
